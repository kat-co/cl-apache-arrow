;;;; Generated by gir2cl on Tue, 10 Dec 2019 22:00:26 +0000
...
(defmethod arrow-array-filter ((arrow-array arrow-array) filter)
  (with-slots (native-pointer)
      arrow-array
    (gir:invoke (native-pointer "filter") filter)))
...
(defmethod feather-file-reader-get-column-data
           ((feather-file-reader feather-file-reader) i)
  (with-slots (native-pointer)
      feather-file-reader
    (gir:invoke (native-pointer "get_column_data") i)))

(defmethod feather-file-reader-get-column-name
           ((feather-file-reader feather-file-reader) i)
  (with-slots (native-pointer)
      feather-file-reader
    (gir:invoke (native-pointer "get_column_name") i)))

(defmethod feather-file-reader-get-description
           ((feather-file-reader feather-file-reader))
  (with-slots (native-pointer)
      feather-file-reader
    (gir:invoke (native-pointer "get_description"))))

(defmethod feather-file-reader-get-n-columns
           ((feather-file-reader feather-file-reader))
  (with-slots (native-pointer)
      feather-file-reader
    (gir:invoke (native-pointer "get_n_columns"))))

(defmethod feather-file-reader-get-n-rows
           ((feather-file-reader feather-file-reader))
  (with-slots (native-pointer)
      feather-file-reader
    (gir:invoke (native-pointer "get_n_rows"))))
...
(defmethod feather-file-reader-has-description
           ((feather-file-reader feather-file-reader))
  (with-slots (native-pointer)
      feather-file-reader
    (gir:invoke (native-pointer "has_description"))))
...
(defclass feather-file-writer (gir-object) (sink))

(defun make-feather-file-writer-new (sink)
  (let ((pointer (gir:invoke (*ns* "FeatherFileWriter" "new") sink)))
    (make-instance 'feather-file-writer :native-pointer pointer)))

(defmethod feather-file-writer-append
           ((feather-file-writer feather-file-writer) name array)
  (with-slots (native-pointer)
      feather-file-writer
    (gir:invoke (native-pointer "append") name array)))

(defmethod feather-file-writer-close
           ((feather-file-writer feather-file-writer))
  (with-slots (native-pointer)
      feather-file-writer
    (gir:invoke (native-pointer "close"))))

(defmethod feather-file-writer-set-description
           ((feather-file-writer feather-file-writer) description)
  (with-slots (native-pointer)
      feather-file-writer
    (gir:invoke (native-pointer "set_description") description)))

(defmethod feather-file-writer-set-n-rows
           ((feather-file-writer feather-file-writer) n-rows)
  (with-slots (native-pointer)
      feather-file-writer
    (gir:invoke (native-pointer "set_n_rows") n-rows)))

(defmethod feather-file-writer-write
           ((feather-file-writer feather-file-writer) table)
  (with-slots (native-pointer)
      feather-file-writer
    (gir:invoke (native-pointer "write") table)))
